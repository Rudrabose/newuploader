...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/rudraprasadpatro")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/rudraprasadpatro"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/CinephilesStudyhub"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using 【﻿ℝ𝗨𝔇ℛѦ】'S BOT SERVICE:\n\n"
        ...
        f"**If you have any questions, feel free to ask [【﻿ℝ𝗨𝔇ℛѦ】](https://t.me/CinephilesStudyhub)! 💬**\n"
        )
    ) 
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[【﻿ℝ𝗨𝔇ℛѦ】](https://t.me/CinephilesStudyhub)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                               ...
                               f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [【﻿ℝ𝗨𝔇ℛѦ】](https://t.me/CinephilesStudyhub)"
